...
define('DB_USER','conglome_ptadmin');
define('DB_PASS' ,'Admin123@#$');
define('DB_NAME', 'conglome_ptadmin');
ini_set('display_errors',1);

$connect=mysqli_connect("localhost","conglome_ptadmin","Admin123@#$","conglome_ptadmin");
...
class DB_con
{
 ...
 {
	 $result=mysqli_query($this->dbh,"select * from products where status=1 and is_featured=1");
	 return $result;
 }
...
$menu_url='http://conglomerateweb.com/preconet/';
$image_url='http://localhost/preconet/ptadmin/media/';
